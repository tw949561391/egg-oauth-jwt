...
module.exports = class OauthModel {
    constructor(app) {
        ...
        this.accessTokenExpireIn = app.config.oauthJwt.oauth.accessTokenLifeTime * 1000;
        this.refreshTokenExpireIn = app.config.oauthJwt.oauth.refreshTokenLifeTime * 1000;
        this.authorizationCodeLifeTime = app.config.oauthJwt.oauth.authorizationCodeLifeTime * 1000;
        this.tokenType = app.config.oauthJwt.oauth.tokenType
        this.app = app;
    }
    ...
    async createAuthorizationCode(client, user, scopes, params) {
        ...
        return await new Promise((resolve) => {
            ...
            const code = this.app.Jwt.sign(codeData, this.certPrimary, codeDataOptions);
            resolve(code);
        })
