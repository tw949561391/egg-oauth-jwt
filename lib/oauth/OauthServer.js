...
class OauthServer {
    ...
    async refreshGrant(request, ctx) {
        const params = Object.assign({}, request.params, request.query, body.body);
    ...
    async authorizationCodeGrant(request, ctx) {
        ...
        const client = await this.model.getClient(clientId, clientSecret, 'authorization_code', paramsAll);
